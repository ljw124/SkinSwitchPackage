package com.hzcominfo.skin.dynamic;
...
import com.hzcominfo.skin.library.base.SkinActivity;
...
public class MainActivity extends SkinActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // File.separator含义：拼接 /， 皮肤包的名字为package.apk
        skinPath = Environment.getExternalStorageDirectory().getAbsolutePath()
                + File.separator + "package.apk";
        ...
        if (("package").equals(PreferencesUtils.getString(this, "currentSkin"))) {
    ...
    public void skinDynamic(View view) {
        ...
        if (!("package").equals(PreferencesUtils.getString(this, "currentSkin"))) {
            ...
            skinDynamic(skinPath, R.color.skin_item_color);
            PreferencesUtils.putString(this, "currentSkin", "package");
